...
public class Human {
    ...
    /*
    Пустой конструктор, если
    конструкторы не указаны,
    то будет
    по умолчанию
    вызваться он*/
    ...
    public Human(String name, double weight) { // Создаем объект для тренера
        this.name = name;
        this.weight = weight;
        // Инкапсуляция(погружение) проверки в класс позволяет избежать проверок в точке
        // создания объекта(дублирования кода), потому что проверка будет в самом
        // объекте
